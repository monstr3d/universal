...
\begin{lemma}
If $C^*$-algebra admits  Gelfand decomposition and 	$\phi:\mathfrak{Gelfand}\left(A \right)\onto  \sY$ is a surjective continuous map then there is the natural injective $*$-homomorphism
\be
C_0\left( \sY\right)  \hookto M\left(A \right) 
\ee
\end{lemma}
\begin{proof}
Let $f \in C_0\left( \sX\right)$ and !!!
\end{proof}
