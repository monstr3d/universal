...
\begin{proof}
	...
	\be 
	\forall \widetilde L_\la\cap \widetilde L \neq \{0\}.
	\ee
	There is a filter $\left\{\widetilde L_\la\cap \widetilde L\right\}$ and there exists an ultrafilter $\left\{\widetilde L_\a\right\}$ such that  $ \left\{\widetilde L_\la\cap \widetilde L\right\}\subset \left\{\widetilde L_\a\right\}$. If $\widetilde \xi$ is represented by $\left\{\widetilde L_\a\right\}$ then from our construction it follows that
	\bean
	\widetilde \xi \in \mathfrak{Gelfand}\left(\widetilde A \right)_{\widetilde L},\\
	\varphi_M\left(\widetilde \xi \right) = \xi
	\eean 
	Taking into account $\mathfrak{Gelfand}\left(\varphi_M \right)\left( \mathfrak{Gelfand}\left(\widetilde A \right)_{\widetilde L}\right)= \mathfrak{Gelfand}\left(A \right)_L$ one has 
	$$
	\mathfrak{Gelfand}\left(\varphi_M \right)\left( \mathfrak{Gelfand}\left(\widetilde A \right)_{\widetilde L}\right)\subset \mathfrak{Gelfand}\left(A \right)_L,
	$$
