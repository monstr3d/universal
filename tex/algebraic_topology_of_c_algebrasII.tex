...
and the above equation means that $\mathfrak{Gelfand}\left(A \right)_L \subset \mathfrak{Gelfand}\left(\varphi_M \right)\left( \mathfrak{Gelfand}\left(\widetilde A \right)_{\widetilde L}\right) $.	Taking into account $\mathfrak{Gelfand}\left(\varphi_M \right)\left( \mathfrak{Gelfand}\left(\widetilde A \right)_{\widetilde L}\right)\subset \mathfrak{Gelfand}\left(A \right)_L$ one concludes that
	...
	$$
	i.e. the image of an element   $\mathfrak{Gelfand}\left(\widetilde A \right)_{\widetilde L}$  of the subbasis of topology $\mathfrak{Gelfand}\left(\widetilde A \right)$ is an element  $\mathfrak{Gelfand}\left( A \right)_{ L}$ of the subbasis  of topology $\mathfrak{Gelfand}\left( A \right)$. It follows that  the image of an element    of the basis of topology $\mathfrak{Gelfand}\left(\widetilde A \right)$ is an element   of the basis  of topology $\mathfrak{Gelfand}\left( A \right)$, so  the map $\mathfrak{Gelfand}\left(\varphi_M \right)$ is open.
\end{proof}
\begin{lemma}
