...
If $A = CT\left(\sX, \dl \right)$ (cf. Notation \ref{ctr_not})  then we define a presheaf $\mathscr{P}'^\dl $ on $\sX$ such that for a pair  $\sU\subset\sV\subset\sX$ of open subsets of $\sX$ one has
\bean
