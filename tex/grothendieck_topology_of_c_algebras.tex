...
\end{definition}
\begin{remark}
The Definition \ref{top_neg_defn} and the Statement  \ref{associated_sheaf_stmnt} yield associated  sheaves on the locale  $\mathfrak{Closed}\left( \sX\right)$. However an associated sheaf of nontrivial sheaf can be 


However it is interesting to obtain explicit construction which does not depend on the Statement  \ref{associated_sheaf_stmnt}.
\end{remark}
\begin{empt}
...
H;(X;A) -1+ R,(X;-d
	...
	\begin{corollary}
		PAGE 192
	4.9. Theorem. If 4 is a sheaf on X and it = {Uo,; a E I} is any open
...
\begin{theorem}
	13.1. Theorem. If each intersection U of at most m + 1 members of it
has
$$
...
\begin{corollary}
	13.2. Corollary. Let .,l be an arbitrary sheaf on the locally compact Hausdorff
