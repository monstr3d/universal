...
\begin{lemma}\label{sh_co_lem}
	Let $\sX$ be a compact locally connected space, and let $L$ is a principal ideal domain. If $L_\sX$ is a constant presheaf (cf. Definition \ref{constant_presheaf_defn}) and $\mathscr L \bydef \mathfrak{Ass}\left( L_\sX\right)$ ia an associated sheaf  then following conditions hold:
	\begin{enumerate}
