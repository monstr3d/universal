...
\end{tikzcd}
	...
	For any $\mathbf{Hered}/A$-object $B$ a  finite family of morphisms $\left\{B_\iota \to B\right\}_{\iota=1,..,n}$, called a \textit{covering} of $B$ if $\bigcap_{\iota=1}^n B_\iota = B$. Recall that morphism any $B'\to B''$ is an inclusion $B'' \subset B'$. 
	\end{definition} 
