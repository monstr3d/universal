...
$$			
	...
	\end{proposition}
	\begin{empt}
		Let $\sX$ be a topological space. If $A$ be an Abelian group then there is, a corresponding constant presheaf  $\mathscr P$ (cf. Definition \ref{constant_presheaf_defn}) on $\sX$. The  corresponding to a tensor product $A \otimes_Z A \to  A$ constant presheaf is $\mathscr P\otimes \mathscr P$. If is a homomorphism $A \otimes_Z A \to  A$ then there is the natural homomorphism $\mathscr P\otimes \mathscr P\to \mathscr P$ of sheaves which induces a homomorphism
		$$
		h!!!
		$$
	\end{empt}
