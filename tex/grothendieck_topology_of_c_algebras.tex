...
(a) Let $B, C\subset A$ be subalgebras. A covering of $B$ is a family $\left\{B_\iota\subset B\right\}_{\iota \in I}$ of subalgebras of $B$ such that $B$ is a generated by a union $\bigcup B_\iota$ hereditary $C^*$-subalgebra (cf. Definition \ref{hered_gen_defn}). Indeed $B$ is an intersection of all hereditary $C^*$-subalgebras of $A$ which contains the union $\bigcup B_\iota$ (cf. Remark \ref{hered_rem}). It follows that $B\cap C$ is an intersection of all hereditary $C^*$-subalgebras of $A$ which contains the union $\bigcup \left( B_\iota\cap C\right)$.
...
\\
(b) If a family $\left\{B_\iota\subset B\right\}$ is a covering of $B$ and for all $\iota$ a family $\left\{C_{\iota j}\subset B_\iota \right\}$ is a covering of $B_\iota$ then $L\left( B_\iota \right)$ one has:
\begin{itemize}
	\item $B$ is the intersection of all hereditary subalgebras containing a union $\cup_\iota B_\iota $,
	\item for each $\iota$ the set $ B_\iota$ is a the intersection of all hereditary subalgebras containing a union $\cup_j  C_{\iota j}$.
\end{itemize}
From these facts it follows that $B$ is the intersection of hereditary subalgebras containing a union $\cup_{\iota j}  C_{\iota j}$, i.e.  $B$ is a generated by a union $\cup_{\iota j}  C_{\iota j}$ hereditary subalgebra (cf. Definition \ref{hered_gen_defn}). It means that 
...
If $A = CT\left(\sX, \dl \right)$ (cf. Notation \ref{ctr_not})  then we define a presheaf $\mathscr{P}'^\dl $ on $\sX$ such that if both $\sU$ and $\sV$ are open subsets of $\sX$, such that $\sV \subset \sU$ then
\bean
...
The space  $\mathrm{Sp\acute{e}}\left(\mathscr P^\dl  \right)$ is a union of all stalks of the sheaf $\mathscr{P}^\dl $. There is a surjective continuous map $\mathrm{Sp\acute{e}}\left(\mathscr P^\dl  \right)\to \sX$ (cf. Exercise \ref{sheaf_etale_exer}).
The set
\bean
...
\end{lemma} 
\begin{proof}
	From the Proposition \ref{ctr_hered_prop} it follows that both $C^*$-algebras $B$ and $A_{\mathrm{Sp\acute{e}}\left(\mathscr P^\dl \right)_B}$ have continuous trace. Otherwise  $A_{\mathrm{Sp\acute{e}}\left(\mathscr P^\dl \right)_B}$ is generated by subalgebras of $B$ so one has an inclusion	$A_{\mathrm{Sp\acute{e}}\left(\mathscr P^\dl \right)_B}\subset B$. Moreover   $A_{\mathrm{Sp\acute{e}}\left(\mathscr P^\dl \right)_B}$ is a hereditary subalgebra of $B$. 	
