...
\ee
(cf. Remark \ref{sheaf_rem}). From the Theorem \ref{closed_cov_thm} it follows that
$\mathscr F^c\in \mathbf{Sh}\left(\mathfrak{Closed}\left( \sX\right) \right)= \mathbf{Sh}\left(\mathfrak{Site}\left( C_0\left(\sX \right) \right) \right)$.
\begin{theorem}
...
\end{theorem}
	...
	%9.5. Theorem. 
	!!! USE THIS THEOREM IN PROOF RINGED FLABBY !!!
