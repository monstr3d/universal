...
As a set the space  $\mathrm{Sp\acute{e}}\left(\mathscr P^A  \right)$ is a union of all stalks of the presheaf $\mathscr{P}^A$. There is a surjective local homeomorphism $\mathrm{Sp\acute{e}}\left(\mathscr P^A  \right)\to \sX$ (cf. Exercise \ref{sheaf_etale_exer}).
...
If $C_0\subset A$ is the  trivial hereditary $C^*$-subalgebra, then the set $\mathscr U'_{C_0}$ 
\bean
\mathscr X^A \bydef \mathrm{Sp\acute{e}}\left(\mathscr P^A \right)\setminus \mathscr U'_{C_0}
\eean
is closed and
\be\label{ctr_top_eqn}
\mathscr U_C \bydef \mathscr U'_C \cap \mathscr X^A
\ee
is an open subset of $X_A$. If $B$ is a hereditary $C^*$-subalgebra of $B$ and
$$
...
\ee
since it is  a union of open subsets $\mathscr U_{C}$. For any open set $\mathscr U\subset \mathscr X$ we define a family 
$$
\mathscr Y^A_{\mathscr U} \bydef  \left\{\left.C \in \mathscr C^A\right| \forall x \in \sX \quad  C_x\in \mathscr X^A \Rightarrow C_x \in \mathscr U\right\}
$$
...
$
\bigcup_{C \in \mathscr Y^A_{\mathscr U}} C$. From our construction it follows that $B$ is generated by the union
$$
\bigcup_{C \in \mathscr Y^A_{\mathscr X^A_B}} C
$$
or equivalently 
