...
\end{empt}
\begin{empt}
Suppose that $d$ is finite, and consider $\C P^d$ as an algebraic manifold with Zariski topology $J_{\mathrm{Zar}}$.  There is a site $\left(\C P^d \right)$. From \ref{compact_alt_constr} it follows that there is a morphism of sites
\be
\left(\mathbf{Hered}/\K, J_\K \right) \to \left(\C P^d, J_{\mathrm{Zar}} \right) 
\ee
(cf. Definition \ref{morphism_of_sites_defn}). From the Theorem \ref{site_mor_thm} it follows that there is a geometric morphism
$$
\mathbf{Sh}\left(\mathbf{Hered}/\K, J_\K \right) \to \mathbf{Sh}\left(\C P^d, J_{\mathrm{Zar}} \right) 
$$
\end{empt}
...
elements, with objects the pairs $(C, r)$, where $r \in \mathscr F(C)$ and $C \in \mathbf{C}$,
...
\coprod_{\substack{u: C'\to C\\r \in R(C)}}\mathbf{y}C' \substack{ \xrightarrow{\th}\\\xrightarrow[\tau]{}} \coprod_{\substack{C \in \mathbf{C}\\r \in R(C)}}\mathbf{y}C\xrightarrow{\eps} \mathscr F;
\ee
specifically, if we write elements of $\coprod_{u,r} \mathbf{y}C'$ as triples $(r, u, v)$ with
$r \in  \mathscr F(C)$, $~u: C' \to C$ and $v \in  \mathbf{y}(C')(B)'= \mathbb{C}\left( B, C'\right)$  for some object
...
\coprod_{\substack{u: C'\to C\\r \in R(C)}}f^*\mathbf{y}C' \substack{ \xrightarrow{\th}\\\xrightarrow[\tau]{}} \coprod_{\substack{C \in \mathbf{C}\\r \in R(C)}}f^*\mathbf{y}C\xrightarrow{\eps} f^*\mathscr F;
\ee
...
$-\otimes_{\mathbf{C}}A:\mathbf{Sets}^{\mathbf{C}^{\mathrm{op}}}\to \E$. Explicitly, for any $R \in \mathbf{Sets}^{\mathbf{C}^{\mathrm{op}}}$ the object $\mathscr F\otimes_{\mathbf{C}}A$ of $\E$ is defined by the following coequalizer:
\be\label{coprod_topos_a_eqn}
\coprod_{\substack{u: C'\to C\\r \in R(C)}}A\left(C' \right)  \substack{ \xrightarrow{\th}\\\xrightarrow[\tau]{}} \coprod_{\substack{C \in \mathbf{C}\\r \in R(C)}}A\left(C \right)\xrightarrow{\eps} \mathscr F\otimes_{\mathbf{C}}A;
\ee
...
such morphism of sites $\phi: \mathbf{C}\to \mathbf{D}$ induces a geometric morphism $\mathbf{Sh}\left(\mathbf{D}, K\right)\xrightarrow{f} \mathbf{Sh}\left(\mathbf{C}, J\right)$.
...
Here we explicitly describe the given by the Theorem \ref{site_mor_thm} geometric morphism $\mathbf{Sh}\left(\mathbf{D}, K\right)\xrightarrow{f} \mathbf{Sh}\left(\mathbf{C}, J\right)$. The direct image if given by
...
\begin{split}
 \mathbf{Sh}\left(\mathbf{C}, J\right)\xrightarrow{f^*}	\mathbf{Sh}\left(\mathbf{D}, K\right),\\
	\mathscr G \mapsto \mathscr G\otimes A_\phi.
\end{split}
\ee
where 
