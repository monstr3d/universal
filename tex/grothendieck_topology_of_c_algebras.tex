...
\bean
\Ext\left( H_{p-1}\left( \mathfrak A\left( \sU\right),M \right)\right)  %\to H^p\left(\mathscr{D}\left( \mathfrak{A}_*\left(\sU \right), M^* \right) \to \Hom\left( \right) 
\eean
...
$$
i^{\sU, \sV}_* : \tilde H^c\left(\sU, L\right) \to \tilde H^c\left( \sU, L\right)
$$
