...
\end{enumerate}
A  proof of these conditions is left to the reader. The existence of the geometric morphism \eqref{geometric_morphism_eqn} follows from the Theorem \ref{morphism_of_sites_thm}/ 
\end{proof}
\begin{empt}
