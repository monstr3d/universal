...
\begin{definition}\label{top_dimlp_defn}\cite{bredon:sheaf}
	16.3. Definition. PAGE 111 Let 4) be a family of supports on X and let L be a fixed
...
\end{definition}
\begin{theorem}\label{top_diml_thm}
	PAGE 111
