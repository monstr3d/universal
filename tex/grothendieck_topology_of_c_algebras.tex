...
$$
\mathfrak{Locale}\left( \widetilde A\right)\to\mathfrak{Locale}\left( A\right).
$$
...
\begin{lemma}\label{hered_open_lem}
...
\end{definition}
	...
	\end{empt}
	\begin{defn}\label{grotendieck_topolgy_defn}
