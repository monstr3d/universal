...
\coprod_{\substack{u: U'\to U\\r \in F_{\mathbf{Hered}/\K}(C)}}A_\phi\left(U' \right)  \substack{ \xrightarrow{\th}\\\xrightarrow[\tau]{}} \coprod_{\substack{U \in \mathbf{Hered}/\K\\r \in F_{\mathbf{Hered}/\K}(U)}}A_\phi\left(U \right)\xrightarrow{\eps} \mathbf{Hered}/\K\otimes_{\mathbf{C}}A_\phi;
\ee
