...
% as the top. (e.g., "\begin{figure*}[!b]" is not normally possible in
	...
	\begin{abstract}
The theory of formal languages operates with the universal languages. Here we consider a concept of universal language which is informal analog of rigorous mathematical notion. The usefulness of this concept is illustrated by an example of conversion of  6D motion simulators.
	\end{abstract}
