...
of distinct irreducible closed subsets of $\sX$ (cf. Definition \ref{top_irreducible_defn}).
	...
	If $\sZ$ is an irreducible closed subset of $\sX$, then the 
...
\begin{definition}
%Definition. 
Let $Q$ be a point of the projective space $\mathbb P$. The rank 2 geometry $\mathbb P/Q$ whose points are
the lines of $\mathbb P$ through $Q$, whose lines are the planes of $\mathbb P$ through $Q$, and whose
incidence is the incidence induced by $Q$ is called the {\it quotient geometry} of $Q$.
We also speak of $\mathbb P$ {\it modulo the point} $Q$.
\end{definition}
\begin{theorem}
%!!! 1.4.1 Theorem.
 Let $\mathbb P$ be a $d$-dimensional projective space, and let $Q$ be a
point of $\mathbb P$. Then the quotient geometry $\mathbb P/ Q$ of $\mathbb P$ modulo $Q$ is a projective space of dimension $d - 1$.
\end{theorem}
\begin{definition}
%Definition. 
