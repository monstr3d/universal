...
%10.6. 
Theorem. Let $\Phi$ be a family of supports on $\sX$ and let $A$ be a subspace
of $\sX$. Let  $\mathscr N$  be a collection of $\Phi$-taut subspaces of $\sX$ containing $A$
and directed downwards by inclusion. Assume that for each $K \in \Phi|K \setminus A$
there is an $N \in \mathscr N$ with $N \in \sX \setminus K$. Then $A$ is $\Phi$-taut $\Leftrightarrow$ the map
$$
...
\bean
\mathscr H^*\left(f, f|A, \mathscr A \right)  \bydef \mathfrak{Sheaf}\left(\left.\sU \mapsto H^*\left( \sU^\bullet, \sU^\bullet \cap A, \mathscr A \right| \sU^\bullet \right)  \right) 
\eean 
on $\sY$.
\end{definition}
\begin{proposition}
...
if $\Phi$ is paracompactifying or if $\Phi$ contains a neighborhood of $Y\bullet$ and $y^\bullet$ is
