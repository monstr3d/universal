...
\bean
\left(C\left( \sX^+\right) \otimes \K \right) \times \left( A \times 
\K\right) \to A \otimes \K,\\
\left(f \otimes x, a \otimes y \right) \mapsto fa \otimes xy;\\
\left( A\otimes \K \right) \times \left( C\left( \sX^+\right) \otimes 
\K\right) \to A \otimes \K,\\
\left(a \otimes y, f \otimes x \right) \mapsto af \otimes yx.
\eean
So there is an inclusion
$
C\left( \sX^+\right) \otimes 
\K\subset M\left(A\otimes \K \right)$ and  diagrams
\bean
\begin{tikzcd}
	~
	...
	C\left( \sX^+\right)\otimes \K \arrow[r, "\varphi^1"]	& M\left( A\otimes \K\right)& & 	\mathrm{Proj}\left( C\left( \sX^+\right)\otimes \K\right)  \arrow[r, "\varphi^1_*"]	& \mathrm{Proj}\left( M\left( A\otimes \K\right)\right) 
\end{tikzcd}
\eean
...
\end{remark}
\begin{empt}\cite{hilsum_scandalis:stab}
If $\sU_1,\sU_2 \nu M$ are open subsets then denote by $\E^{\sU_1}_{\sU_2}$ or $C^*_r\left( \G^{\sU_1}_{\sU_2}\right)$ the $C^*$-Hilbert $C^*_r\left( \G^{\sU_1}_{\sU_1}\right)$-module as the completion of  pre-$C^*$-Hilbert module $C_c\left( \G^{\sU_1}_{\sU_1}\right)$ with $C^*_r\left( \G^{\sU_1}_{\sU_1}\right)$-valued product
