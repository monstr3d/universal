...
From \ref{sheaf_h_comp_eqn} it follows that $H^0_c\left(\R, \sS \right)\cong  H^1_c\left(\R, \Z \right)\cong \Z$.
If   $f:\mathfrak{Gelfand}\left(A \right) \times  \R\to \R$ from the equation \eqref{cohom_mor_eqn} one has a diagram
\bean
\begin{tikzcd}
... \arrow[r] &  H^0_c\left(\R, \sS \right) \arrow[r]  \arrow[d]&  H^1_c\left(\R, \Z \right) \arrow[r]  \arrow[d] & ...\\
... \arrow[r] &  H^0_c\left(\mathfrak{Gelfand}\left(A \right) \times\R, f^*\sS \right) \arrow[r] &  H^1_c\left(\mathfrak{Gelfand}\left(A \right) \times\R, \Z \right) \arrow[r] & ...\\
... \arrow[r] &  H^0_c\left(\mathfrak{Gelfand}\left(A \right) , f^*\sS \right) \arrow[r]\arrow[u] &  H^1_c\left(\mathfrak{Gelfand}\left(A \right), \Z \right) \arrow[r]\arrow[u] & ...
	\end{tikzcd}
\eean
