...
$$
\forall y \in \sV\quad  \rep_y\left(B\right) \cong  \mathbb{M}_d\left(\C\right).
$$
...
$$
There is a  $C^*$-subalgebra $B' \subset  B$
$$
...
If  $C', C''\subset \xi$ are two commutative!!! $C^*$-algebras  then one has
$$
