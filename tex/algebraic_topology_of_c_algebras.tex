...
\end{proof}
	...
	\be
	\begin{split}
		\mathfrak{Gelfand}\left(SA  \right) \cong \R \times \mathfrak{Gelfand}
	\end{split}
	\ee
	\end{lemma}
...
\end{split}
\eean
From the Theorem  \ref{gelfand_suspension_lem} it follows that \ref{gelfand_suspension_lem}
