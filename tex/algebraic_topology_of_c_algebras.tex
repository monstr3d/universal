...
\begin{definition}
We recall: a collineation of P is a bijective map from the point set and line set
of P onto themselves that preserves incidence.\end{definition}
	\begin{definition}
...
\end{itemize}
	\end{definition}
	\begin{theorem}
2.2.1 Theorem. Let V be a vector space of dimension d + lover a division ring
F. Then the theorem of Des argues holds in P(V).
	\end{theorem}
	\begin{definition}
...
{\it hyperplanes} of $P$,\end{definition}
...
\subsection{Intersections and Chow ring}
...
equivalent}, written $D \sim D'$ if $D Ñ D'$ is a principal divisor. The group $\mathrm {Div}\sX$ of all divisors divided by the subgroup of principal divisors is 
