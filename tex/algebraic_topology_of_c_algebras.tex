...
\begin{definition}\cite{bredon:sheaf}
	...
	$C^n_\Phi\left( \bullet; \bullet \right)$ and $\mathscr Z^n\left( \sX ; \bullet \right)$) are all exact functors.
	2.2. Definition. For a family of supports on X and for a sheaf d on
	X we define
	I HH(X; d) = H"(C,(X;4)). I!!!!!
