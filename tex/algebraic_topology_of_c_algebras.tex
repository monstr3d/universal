...
\begin{tikzcd}
	~
	& A \otimes \K \arrow[d, "\varphi^2"] & & \mathrm{Proj}^{\mathrm{nat}}\left(A \otimes \K\right) \arrow[r, "\subset"] \arrow[d, "\varphi_*"]& \mathrm{Proj}\left( A\otimes \K\right)   \arrow[d, "\varphi^2_*"]\\
	C\left( \sX^+\right) \arrow[r, "\varphi^1"]	& M\left( A\otimes \K\right)& & 	\mathrm{Proj}\left( C\left( \sX^+\right)\right)  \arrow[r, "\varphi^1_*"]	& \mathrm{Proj}\left( M\left( A\otimes \K\right)\right) 
\end{tikzcd}
\eean
