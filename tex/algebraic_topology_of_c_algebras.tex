...
\begin{remark}
Any open subset of $\sU = \mathbb{P}\left(\H \right)_{\mathfrak{Gelfand}}$ equals to
\be\label{open_g_eqn}
\sU = \mathbb{P}\left(\H \right)_{\mathfrak{Gelfand}}\setminus \bigcap_{j= 0}^n V_j
\ee
...
If $\mathscr W= \left\{ \mathbb{P}\left(\H \right) \setminus L_j\right\}_{j = 0, 1, ... }$ or  $\mathscr W= \left\{ \mathbb{P}\left( \C^n\right)\setminus L_j\right\}_{j = 0,..., n }$ then
...
One has
\be
\mathbb{P}\left( \E\right) = \bigcup_{\substack{\sU\in K\left( \mathscr{U}\right) \\ \mathcal W \in  K\left( \mathscr W\right)  }} \sU \times \mathcal W
\ee
...
\textit{title}\subsection{Gelfand space of $C^*$-algebras of groupoids}
...
\be\label{top_lift_o_eqn}
 H^n\left( A \times I \cup X \times \dot I; \pi \right) \xrightarrow{\delta}  H^{n+1}\left( \left( \sX,A\right) \times \left( I, \dot I\right) ; \pi\right)
\ee
 \begin{definition}\cite{spanier:at}
