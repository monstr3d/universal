...
\end{proof}
	...
	\end{split}
	\eean
If $\left(x, r \right)\in \mathfrak{Gelfand}\left(A  \right)\times \R$, both $\left\{\sU_\la\right\}_{\la\in \La}$, $\left\{\sV_\la\right\}_{\la\in \La}$ ares bases on neighborhoods of $x$ and $r$ then $\left\{\sU_\la\times \sV_\la\right\}_{\la\in \La}$ is a  basis of neighborhoods of $\left(x, r \right)$. Any pair yields a closed left ideal $L\la\subset A\otimes_\C C_0\left(\R \right)$. If the set $\left\{L_\la\right\}_{\la]\in \La}$ is not an ultrafilter then 
$$
\bigcap_{\la \in \La} L_\la \neq \{0\}
$$
