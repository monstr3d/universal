...
\begin{definition}\label{hausdorff_defn}
	...
	\begin{itemize}
		\item objects of $\mathfrak{Hausdorff}\left( \sX\right)$ are continuous surjective maps $\sX \onto \sY$ onto Hausdorff locally compact (cf. Definition \ref{top_locally_compact_defn}) space, 
...
\begin{definition}\label{top_characteristic_function_defn}
	If $\sX$ is a set and $\sU \subset \sX$ is a compact set  (cf. Definition \ref{top_compact_defn}) then the map 
...
\end{definition}
\begin{rem}
If $\sX$ is a Hausdorff, locally compact  space (cf. Definition \ref{top_locally_compact_defn}) and $D\left( \sX\right)$ is a $C^*$-algebra of bounded maps from $\sX$ to $\C$ then one can proof that  for any $f \in C_0\left( \sX\right)$  there is a $C^*$-norm limit
\be
