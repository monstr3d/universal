...
\subsection{Formal fiber bundles}
\paragraph{} The notion of fiber bundle (cf. Definition \ref{top_bundle_defn}) is a powerful tool of calculation in the Algebraic topology. In many cases the fibre bundles can be replaced with explained in \cite{spaier:at} fibrations. Here we consider another alternative of fibre bundles.\begin{lemma}\label{zero_product_lem}
...
\ee
!!!! CORRECT !!!where $\sX$ is the spectrum of $A$.  So there are following maps 
\be\label{ctr_g_eqn}
\begin{split}
