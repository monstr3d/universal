...
\begin{remark}
	...
	\begin{split}
		S \xrightarrow{\hat \phi} \hat A,\\
		S'' \xrightarrow{\hat \phi''}  \hat A
	\end{split}
	\ee
	where the subset $S\subset \mathfrak{Gelfand}\left(A \right)$ (resp. $S''\subset \mathfrak{Gelfand}\left(A \right)''$) is the  \textit{domain} of $\hat \phi$ (resp.  $\hat \phi''$) respectively. 
\end{remark}
