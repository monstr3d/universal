...
$$ 
	...
	\begin{split}
		\mathfrak{LeftMax}\left(\varphi \right)\left( \widetilde \xi\right) = \xi \quad \Leftrightarrow \quad \widetilde \xi \in \mathfrak{LeftMax}\left(\varphi_M \right)^{-1}\left(\xi \right),\\
