...
\begin{definition}
	...
	\end{enumerate}
		The final object (cf. Definition \ref{terminal_ob_defn})of this category $C_0\left( \sX\right) \hookto M\left(A \right)$ is  \textit{universal Blowing-up of $A$}.
\end{definition}	
...
\end{proof}
\begin{definition}
	The initial object of the category $\sX$-{Hausdorff category} is the	$\sX$ - \textit{universal Hausdorff space}.
\end{definition}
