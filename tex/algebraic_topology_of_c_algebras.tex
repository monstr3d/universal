...
Let us describe an  analogy  between algebraic counterpart of geometric quotient and Connes quantization. If $A$ is a $C^*$-algebra and   $C_0\left( \sX\right)\subset M\left(A \right)$ is natural Hausdorff blowing-up (cf. Definition \ref{blowing_universal_defn} !!!). Suppose that the equation \eqref{to_spec_eqn}  yields the following diagram of commutative maps
...
!!!!
\begin{proof}
	One should prove that Hausdorff blowing-up $C_0\left(M \right) \hookto (C^*_r\left(M, \F \right)$ is natural (cf. Definition \ref{blowing_universal_defn} !!!). If not then there is a diagram 
	...
	with Hausdorff $\sX$ and continuous map $\phi$ with $x', x''\in  \sX$ such that $x'\neq x''$ and $\phi\left( x'\right) = \phi\left( x''\right)= y \in M$. Since $\sX$ is a Hausdorff space there are open neighborhoods $\sU'$ and $\sU''$ of $x'$ and $x''$ such that $\sU'\cap \sU'' = \emptyset$. If $\xi', \xi'' \in  	\mathfrak{Gelfand}\left(C^*_r\left(M, \F \right)\right)$ with $\psi\left(\xi' \right)= x'$ and $\psi\left(\xi'' \right)= x''$  then there are neighborhoods $\sV'$ and $\sV''$ of $\xi'$ and $\xi''$ such that $\sV'\cap \sV'' = \emptyset$. Let us use the notation \eqref{topology_base_herd_eqn}  and suppose that 
					\bean
	\begin{split}
		\sV'\bydef	\left\{ \xi \in 	\mathfrak{Gelfand}\left(C^*_r\left(M, \F \right)\right) \left| \exists B \in \xi\quad B\cap \left( \bigcup_{j=1}^m B'_j\right)  = \{0\}\right. \right\},\\
		\sV''\bydef	\left\{ \xi \in 	\mathfrak{Gelfand}\left(C^*_r\left(M, \F \right)\right) \left| \exists B \in \xi\quad B\cap \left( \bigcup_{j=1}^n B''_j\right)  = \{0\}\right. \right\},
	\end{split}
	\eean
	so one has
