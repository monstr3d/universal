...
\begin{definition}\label{covering_defn}
	Let   $A$ and  $\widetilde{A}$ be  connected $C^*$-algebras.  A good     $*$-homomorphism $\lift: A  \hookto M\left( \widetilde{A}\right)$ (cf. Definition 
...
\subsection{Fundamental group of commutative $C^*$-algebras}!!! REPLACED ggg !!!
