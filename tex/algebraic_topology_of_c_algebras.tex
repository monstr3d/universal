...
Below we will use alternative notation
...
\end{split}
\ee
The equations \eqref{tor_prodU_eqn} can be regarded as both $K$-theoretic and sheaf-theoretic where the cup product is given by the Theorems \ref{cup_prod_thm} and  \ref{cup_sheaf_thm} respectively.
...
\begin{theorem}\label{suspension_thm}\cite{blackadar:ko}
	...
	\bean
	\begin{tikzcd}
		K_0\left(A \right) \arrow[r, "K_0\left(\phi \right)" ]  \arrow[d, "\bt_A" ]& K_0\left(B \right)\arrow[d, "\bt_B" ]\\ 
