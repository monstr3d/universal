...
\begin{enumerate}
	...
	2. $I$?cof be the set of morphisms in $\M$ having the left lifting property with
...
\end{definition}
		\begin{definition}\cite{motivic}.
Definition 3.0.2 A cofibrantly generated model category is a model category
M in which there exists
1. a set I of cofibrations which permits the small object argument and for
which the cofibrations and I-cofibrations coincide.
2. a set J of trivial cofibrations which permits the small object argument
and for which the trivial cofibrations and J-cofibrations coincide.\end{definition}
