...
%A^\sim\bydef\begin{cases}
	...
	\end{split}
	\ee 
	Taking into account the equations \eqref{stab_k1_eqn} and \eqref{royden_eqn} one has
	\be\label{k_1_h_eqn}
	\begin{split}
