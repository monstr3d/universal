...
\bean
\begin{tikzcd}
... \arrow[r] &  H^0_c\left(\R, \sS \right) \arrow[rr, "\dl_\R"]  \arrow[d, "H^0_c\left( f\right)" ]&&  H^1_c\left(\R, \Z \right) \arrow[r]  \arrow[d, "H^1_c\left( f\right)"] & ...\\
... \arrow[r] &  H^0_c\left(\mathfrak{Gelfand}\left(A \right) \times\R, f^*\sS \right) \arrow[rr, "\dl_{\mathfrak{Gelfand}}"] &&  H^1_c\left(\mathfrak{Gelfand}\left(A \right) \times\R, \Z \right) \arrow[r] & ...
	\end{tikzcd}
\eean
...
\smile :K_1\left(A \right) \otimes K_0\left(A \right) \to K_1\left(A \right)\eean
