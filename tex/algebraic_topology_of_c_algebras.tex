...
\end{split}
\ee
Let us consider there sheaves $\sR$, $\sS$ and $\sZ$ on $\R$ which corresponds to sheaves of continuous maps from $\R$ to $\R$, $S^1$ and $\Z$  respectively.  There is an exact sequence of sheaves
...
\bean
\begin{split}
	\{0\}  \to  H^0_c\left(\R, \Z\right)  \to  H^0_c\left(\R, \sR \right)\to  H^0_c\left(\R, \sS \right)\xrightarrow{\dl }  H^1_c\left(\R, \Z \right)\to ...
\end{split}
\eean
