...
topology  and $B\left(\H_\rho \right)$  the weak operator topology then the algebraic tensor product  $K\left(   C^*_r\left( \widetilde \G, \widetilde{\sigma}\right)\right)\otimes_{ C^*_r\left( \widetilde \G, \widetilde{\sigma}\right)} \H_\rho$ is a pre-Hilbert space with the product
\bean
...
topology  and $B\left(\H_{\widetilde \rho} \right)$  the weak operator topology,
\section{Main result}
\begin{frame}
\huge Main result \normalsize
\begin{definition}
