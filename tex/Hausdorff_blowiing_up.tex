...
\begin{enumerate}
	...
	\item 		Experimentally proved physics is not self-consistent since it contains high-energy  divergences.
...
\huge{Infinite coverings} \normalsize\\
	...
	\ee
	Usage of the {finite covering algebraic functor} $C_0$  yields a category  given by
	\bean
	\begin{split}
