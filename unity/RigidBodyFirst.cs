...
namespace GeneratedProject
{
	public static class RigidBodyFirst
	{
		...
		internal class IntrenalDesktop : Diagram.UI.PureDesktop
		{
			...
			{
				objects.Add(new IntrenalDesktop.OblectLabel0("Base", this));
				objects.Add(new IntrenalDesktop.OblectLabel1("Measurements", this));
				objects.Add(new IntrenalDesktop.OblectLabel2("Force", this));
				objects.Add(new IntrenalDesktop.OblectLabel3("Timer", this));
				objects.Add(new IntrenalDesktop.OblectLabel4("Rigid Body", this));
