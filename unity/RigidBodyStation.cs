	...
	public static class RigidBodyStation
	{
		...
		internal class IntrenalDesktop : Diagram.UI.PureDesktop
		{
			internal IntrenalDesktop()
			{
				...
				objects.Add(new IntrenalDesktop.OblectLabel7("Z-Control", this));
				objects.Add(new IntrenalDesktop.OblectLabel8("Y-Control", this));
				objects.Add(new IntrenalDesktop.OblectLabel9("X-Frame-1", this));
				objects.Add(new IntrenalDesktop.OblectLabel10("X-Control 2", this));
				objects.Add(new IntrenalDesktop.OblectLabel11("Consumer", this));
				objects.Add(new IntrenalDesktop.OblectLabel12("Shifted Frame", this));
				objects.Add(new IntrenalDesktop.OblectLabel13("Aim 1", this));
				objects.Add(new IntrenalDesktop.OblectLabel14("Aim 2", this));
