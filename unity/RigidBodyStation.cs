	...
	public static class RigidBodyStation
	{
		...
		internal class IntrenalDesktop : Diagram.UI.PureDesktop
		{
			internal IntrenalDesktop()
			{
				...
				objects.Add(new IntrenalDesktop.OblectLabel11("Shifted Frame", this));
				objects.Add(new IntrenalDesktop.OblectLabel12("Aim 1", this));
				objects.Add(new IntrenalDesktop.OblectLabel13("Aim 2", this));
