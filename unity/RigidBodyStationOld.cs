...
{
	public static class RigidBodyStationOld
	{
		...
		internal class IntrenalDesktop : Diagram.UI.PureDesktop
		{
			internal IntrenalDesktop()
			{
				...
				objects.Add(new IntrenalDesktop.OblectLabel4("Shifted Frame", this));
				objects.Add(new IntrenalDesktop.OblectLabel5("Force", this));
				objects.Add(new IntrenalDesktop.OblectLabel6("Rigid Body", this));
				objects.Add(new IntrenalDesktop.OblectLabel7("Relative to station", this));
				objects.Add(new IntrenalDesktop.OblectLabel8("Timer", this));
				objects.Add(new IntrenalDesktop.OblectLabel9("X - Control", this));
				objects.Add(new IntrenalDesktop.OblectLabel10("Consumer", this));
