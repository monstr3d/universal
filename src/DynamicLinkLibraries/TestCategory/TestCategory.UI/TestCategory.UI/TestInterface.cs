...
namespace TestCategory.UI
{
    ...
    public class TestInterface : ITestInterface
    {
        ...
        protected event Action<object, DataRow, TestCollection> add =
            (object o, DataRow r, TestCollection d) => { };

        protected Action<object, ICategoryObject, bool[]> addmissible =
            (object l, ICategoryObject o, bool[] b) => { b[0] = false; }; 

        protected Func<TestCollection> createTest = () => { return new TestCollection(new ITest[0]); };
