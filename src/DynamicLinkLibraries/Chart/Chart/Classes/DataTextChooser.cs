...
namespace Chart.Classes
{
    /// <summary>
    /// Chooser of data text
    /// </summary>
    public static class DataTextChooser
    {
        #region Fields
        private static Action<Control> localize;
        #endregion
...
*/
        ...
        /// Localize action
        /// </summary>
        public static Action<Control> Localize
        {
            get
            {
                return localize;
