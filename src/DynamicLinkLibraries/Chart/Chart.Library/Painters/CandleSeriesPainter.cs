...
namespace Chart.Library.Painters
{
    /// <summary>
    ...
    public class CandleSeriesPainter : SimpleSeriesPainter
    {
        ...
        /// Constructor
        /// </summary>
        public CandleSeriesPainter() : 
            this(System.Drawing.Color.LightGreen, System.Drawing.Color.LightPink)
        {
        ...
        /// Constructor
        /// </summary>
        /// <param name="up">Up color</param>
        /// <param name="down">Down color</param>
