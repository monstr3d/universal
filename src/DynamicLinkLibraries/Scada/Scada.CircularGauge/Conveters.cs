...
namespace Scada.CircularGauge
{
    ...
    public class EventConverter : ConverterBase
    {
        ...
        {
            return new StandardValuesCollection(StaticExtensionCicularGauge.Scada.Events);
        }
    }
    ...
    public class InputRealConverter : ConverterBase
    {
        ...
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            return new StandardValuesCollection(StaticExtensionCicularGauge.Scada.GetRealList(true));
        }
    }
    ...
    public class OutputRealConverter : ConverterBase
    {
        ...
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            return new StandardValuesCollection(StaticExtensionCicularGauge.Scada.GetRealList(false));
        }
    }
    ...
    public class OutputConverter : ConverterBase
    {
        ...
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            return new StandardValuesCollection(StaticExtensionCicularGauge.Scada.GetDataList(false));
        }
    }
    ...
    public class OutputBooleanConverter : ConverterBase
    {
        ...
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            return new StandardValuesCollection(StaticExtensionCicularGauge.Scada.GetTypeList(typeof(bool)));
        }
    }
    ...
    public class OutputBitmapConverter : ConverterBase
    {
        ...
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            return new StandardValuesCollection(StaticExtensionCicularGauge.Scada.GetTypeList(typeof(System.Drawing.Bitmap)));
        }
    }
