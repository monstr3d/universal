...
namespace Scada.Wpf.Common.Convertes
{
    /// <summary>
    /// Base converter
    /// </summary>
    ...
    public class EventConverter : ConverterBase
    {
        ...
        {
            return new StandardValuesCollection(StaticExtensionScadaWpfCommon.Scada.Events);
        }
    }
    ...
    public class InputRealConverter : ConverterBase
    {
        ...
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            return new StandardValuesCollection(StaticExtensionScadaWpfCommon.Scada.GetRealList(true));
        }
    }
    ...
    public class OutputRealConverter : ConverterBase
    {
        ...
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            return new StandardValuesCollection(StaticExtensionScadaWpfCommon.Scada.GetRealList(false));
        }
    }
    ...
    public class OutputConverter : ConverterBase
    {
        ...
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            return new StandardValuesCollection(StaticExtensionScadaWpfCommon.Scada.GetDataList(false));
        }
    }
    ...
    public class OutputBooleanConverter : ConverterBase
    {
        ...
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            return new StandardValuesCollection(StaticExtensionScadaWpfCommon.Scada.GetTypeList(typeof(bool)));
        }
    }
    ...
    public class OutputBitmapConverter : ConverterBase
    {
        ...
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            return new StandardValuesCollection(StaticExtensionScadaWpfCommon.Scada.GetTypeList(typeof(System.Drawing.Bitmap)));
        }
    }
