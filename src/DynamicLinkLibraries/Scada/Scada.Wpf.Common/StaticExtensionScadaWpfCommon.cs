...
using Scada.Wpf.Common.ErrorHandlers;

namespace Scada.Wpf.Common
{
    /// <summary>
    /// Static extensions
    /// </summary>
    public static class StaticExtensionScadaWpfCommon
    {
        #region Fields
        ...
        static StaticExtensionScadaWpfCommon()
        {
        ...
        {
            StaticExtensionScadaWpfCommon.factory.Add(factory);
        }
