               ...
               new ButtonWrapper[] 
                {
                            new ButtonWrapper(typeof(BitmapSelection),
                               "", "Image Selection", Resources.Contour, ImageNavigationFactory.Object, true, false),
                            new ButtonWrapper(typeof(BitmapGraphSelection),
                               "", "Graph selection bitmap", Resources.BitmapGraphSelection, ImageNavigationFactory.Object, true, false),
                            new ButtonWrapper(typeof(BitmapColorTable),
                               "", "Color table", Resources.BitmapColorSelection, ImageNavigationFactory.Object, true, false),
                };
               ...
               new ButtonWrapper[] 
                {
                            new ButtonWrapper(typeof(BitmapMeasurementsLink),
                               "", "Link between bitmap selection and camera", Resources.ContourLink, ImageNavigationFactory.Object, true, true),
                };
