...
{
    public class TernaryFunctionSymbolDrawable : TernaryFunctionSymbol, IDrawableSymbol
    {
        ...
        public TernaryFunctionSymbolDrawable(TernaryFunctionSymbol symbol)
        ...
        {
            return new TernaryFunctionSymbolDrawable(this);
        }
        ...
        public override void SetToFormula(MathFormula formula)
        {
            ...
            pDrawable.ChildPositions = new Point[] { new Point(), new Point(), new Point() };
        }
        ...
        public void DrawSelf(Graphics g)
        {
            ...
            g.DrawString(" , ", pDrawable.Font, PureDrawableSymbol.SymbolBrush, x + warc + wc + f0.FullRelativeRectangle.Width + f1.FullRelativeRectangle.Width, y);
            int ww = 0;
            ...
            g.DrawArc(PureDrawableSymbol.LinePen, x + 2 + 2 * warc + ww + 2 * wc - 4 * h, y - 2 * h, 4 * h, 4 * h, -40, 80);
        }
        ...
        {
            Point[] p = new Point[] { GetChildPosition(0), GetChildPosition(1), GetChildPosition(2) };
            pDrawable.Font = PureDrawableSymbol.FontsBold[level];
            MathFormulaDrawable[] f = {
                                          this[0] as MathFormulaDrawable,
										  this[1] as MathFormulaDrawable,
 										  this[2] as MathFormulaDrawable
                                      };
            ...
            { 
                f[0].FullRelativeRectangle, 
                f[1].FullRelativeRectangle, 
                f[2].FullRelativeRectangle 
            };
