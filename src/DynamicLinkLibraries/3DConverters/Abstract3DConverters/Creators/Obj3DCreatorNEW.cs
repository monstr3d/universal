...
namespace Abstract3DConverters.Creators
{
    ...
    public abstract class Obj3DCreatorNEW : LinesMeshCreator, IAdditionalInformation
    {
        #region Ctor

        public Obj3DCreatorNEW(string filename, byte[] bytes, object additional) : base(filename, bytes, additional)
        {
        ...
        protected override IEnumerable<IMesh> Meshes
        {
            get
            {
                ...
                {
                    yield return new AbstractMeshObj(i, null);
                }
                yield break;
