...
{
    public abstract class ColladaMeshConverter : XmlConverter
    {
        ...
        protected override XmlDocument Combine(IEnumerable<object> meshes)
        {
            return doc;
        }
        ...
        protected virtual void Set(Dictionary<string, object> images)
        {
            int i = 1;
            this.images = images;
