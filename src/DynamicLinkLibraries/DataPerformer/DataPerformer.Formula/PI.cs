...
{
	public  class PI : Diagram.UI.PureDesktop
	{
		public PI()
		{
			objects.Add(new PI.OblectLabel0("X", this));
			objects.Add(new PI.OblectLabel1("Y", this));
			objects.Add(new PI.OblectLabel2("Data", this));
			objects.Add(new PI.OblectLabel3("Recursive", this));
			objects.Add(new PI.OblectLabel4("Chart", this));
			Diagram.UI.Labels.PureArrowLabel currALabel = null;
			currALabel  = new PI.ArrowLabel0("2", this);
			arrows.Add(currALabel);
			currALabel.SourceNumber = (int)2;
			currALabel.TargetNumber = (int)1;
			currALabel  = new PI.ArrowLabel1("1", this);
			arrows.Add(currALabel);
			currALabel.SourceNumber = (int)2;
			currALabel.TargetNumber = (int)0;
			currALabel  = new PI.ArrowLabel2("3", this);
			arrows.Add(currALabel);
			currALabel.SourceNumber = (int)3;
			currALabel.TargetNumber = (int)2;
			currALabel  = new PI.ArrowLabel3("4", this);
			arrows.Add(currALabel);
