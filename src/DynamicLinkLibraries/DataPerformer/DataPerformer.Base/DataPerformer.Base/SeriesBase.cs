...
namespace DataPerformer
{
    ...
    /// </summary>
    public class SeriesBase : Basic.Series, ISerializable, ICategoryObject, IArgumentSelection,
       IStructuredSelection, IStructuredSelectionCollection, IMeasurement, IMeasurements, IAliasVector
    {
...
/*
        class WMeasure : IMeasurement
        {
            private SeriesBase s;

            

            internal WMeasure(SeriesBase s)
            {
                this.s = s;
            ...
            object IMeasurement.Type
            {
                get
                {
                    return new ArrayReturnType((double)0, new int[] { -1 }, false);
                }
            }

            object Par()
            {
                object[] o = s.measureParameter[0]() as object[];
        ...
        class ZMeasure : IMeasurement
        {
            private SeriesBase s;

            internal ZMeasure(SeriesBase s)
            {
                this.s = s;
            ...
            object IMeasurement.Type
            {
                get
                {
                    return new ArrayReturnType((double)0, new int[] { -1 }, true);
                }
            }
        }
        */
