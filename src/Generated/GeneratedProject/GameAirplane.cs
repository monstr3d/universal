...
namespace GeneratedProject
{
	public static class GameAirplane
	{
		...
		internal class IntrenalDesktop : Diagram.UI.PureDesktop
		{
			...
			{
				objects.Add(new IntrenalDesktop.OblectLabel0("Coefficient", this));
				objects.Add(new IntrenalDesktop.OblectLabel1("Motion", this));
				objects.Add(new IntrenalDesktop.OblectLabel2("Timer", this));
				objects.Add(new IntrenalDesktop.OblectLabel3("Plane frame", this));
				objects.Add(new IntrenalDesktop.OblectLabel4("Unity plane", this));
				objects.Add(new IntrenalDesktop.OblectLabel5("Consumer", this));
				objects.Add(new IntrenalDesktop.OblectLabel6("Left frame", this));
				objects.Add(new IntrenalDesktop.OblectLabel7("Forward frame", this));
				objects.Add(new IntrenalDesktop.OblectLabel8("Unity camera", this));
