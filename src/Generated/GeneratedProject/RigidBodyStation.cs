	...
	public static class RigidBodyStation
	{
		...
		internal class IntrenalDesktop : Diagram.UI.PureDesktop
		{
			internal IntrenalDesktop()
			{
				...
				objects.Add(new IntrenalDesktop.OblectLabel7("Y - Control", this));
				objects.Add(new IntrenalDesktop.OblectLabel8("Z - Control", this));
				...
				arrows.Add(currALabel);
				currALabel.SourceNumber = new object[] {(int)7,"Igla/Mod" };
				currALabel.TargetNumber = (int)2;
				currALabel  = new IntrenalDesktop.ArrowLabel16("", this);
				arrows.Add(currALabel);
				currALabel.SourceNumber = (int)9;
				currALabel.TargetNumber = new object[] {(int)7,"Limiter" };
				bool pl = PostLoad();
			...
			internal class OblectLabel7 : Diagram.UI.Labels.PureObjectLabel
			{
				...
				internal class CategoryObject : Diagram.UI.ObjectContainerPortable
				{
					...
					new internal class Desktop : Diagram.UI.PureDesktop
					{
						internal Desktop()
						{
							objects.Add(new IntrenalDesktop.OblectLabel7.CategoryObject.Desktop.OblectLabel0("Igla", this));
							objects.Add(new IntrenalDesktop.OblectLabel7.CategoryObject.Desktop.OblectLabel1("Limiter", this));
							Diagram.UI.Labels.PureArrowLabel currALabel = null;
						...
						internal class OblectLabel0 : Diagram.UI.Labels.PureObjectLabel
						{
							...
							internal class CategoryObject : Diagram.UI.ObjectContainerPortable
							{
								...
								new internal class Desktop : Diagram.UI.PureDesktop
								{
									internal Desktop()
									{
										objects.Add(new IntrenalDesktop.OblectLabel7.CategoryObject.Desktop.OblectLabel0.CategoryObject.Desktop.OblectLabel0("Mod", this));
										objects.Add(new IntrenalDesktop.OblectLabel7.CategoryObject.Desktop.OblectLabel0.CategoryObject.Desktop.OblectLabel1("Force", this));
										objects.Add(new IntrenalDesktop.OblectLabel7.CategoryObject.Desktop.OblectLabel0.CategoryObject.Desktop.OblectLabel2("Epsilon", this));
										Diagram.UI.Labels.PureArrowLabel currALabel = null;
										currALabel  = new IntrenalDesktop.OblectLabel7.CategoryObject.Desktop.OblectLabel0.CategoryObject.Desktop.ArrowLabel0("", this);
										arrows.Add(currALabel);
										currALabel.SourceNumber = (int)1;
										currALabel.TargetNumber = (int)0;
										currALabel  = new IntrenalDesktop.OblectLabel7.CategoryObject.Desktop.OblectLabel0.CategoryObject.Desktop.ArrowLabel1("", this);
										arrows.Add(currALabel);
										currALabel.SourceNumber = (int)2;
										currALabel.TargetNumber = (int)1;
										currALabel  = new IntrenalDesktop.OblectLabel7.CategoryObject.Desktop.OblectLabel0.CategoryObject.Desktop.ArrowLabel2("", this);
										arrows.Add(currALabel);
										currALabel.SourceNumber = (int)2;
										currALabel.TargetNumber = (int)0;
									}
