...
class TimeSpan {
    ...
    static millisecondsPerTick = 1.0 / TimeSpan.ticksPerMillisecond;
    static ticksPerSecond = TimeSpan.ticksPerMillisecond * 1000; // 10,000,000
    static secondsPerTick = 1.0 / TimeSpan.ticksPerSecond; // 0.0000001
    static ticksPerMinute = TimeSpan.ticksPerSecond * 60; // 600,000,000
    static minutesPerTick = 1.0 / TimeSpan.ticksPerMinute; // 1.6666666666667e-9
    static ticksPerHour = TimeSpan.ticksPerMinute * 60; // 36,000,000,000
    static hoursPerTick = 1.0 / TimeSpan.ticksPerHour; // 2.77777777777777778e-11
    static ticksPerDay = TimeSpan.ticksPerHour * 24; // 864,000,000,000
    static daysPerTick = 1.0 / TimeSpan.ticksPerDay; // 1.1574074074074074074e-12
    ...
    static maxValue = new TimeSpan(Number.MAX_VALUE);
    static minValue = new TimeSpan(Number.MIN_VALUE);
    _ticks;
    constructor(args) {
