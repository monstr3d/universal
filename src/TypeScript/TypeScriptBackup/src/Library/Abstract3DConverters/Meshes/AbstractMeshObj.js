...
class AbstractMeshObj extends AbstractMeshPolygon_1.AbstractMeshPolygon {
    constructor(parent, name, transformationMatrix, effect, polygons, vertices, textures, normals, tuple, creatorObj, variant, meshNumber) {
        super(parent, name, transformationMatrix, effect, polygons, vertices, textures, normals, tuple, creatorObj);
        this.global = new Map();
        this.np = 0;
        this.shift = 0;
        this.shiftTexture = 0;
        ...
        if (variant == 0) {
            ...
            for (let tuple of indexes) {
                new AbstractMeshObj(this, "", [], effect, [], this.intVertices, this.intTextures, this.intNormals, tuple, this.o3dCreator, 1, nm);
                ++nm;
            }
            return;
        }
