...
export interface IScene extends IObjectCollection, IExternalAction, IFactoryConsumer, ISelfStart, IAddAction, ISelfLoad, IStepActionHolder, IChildrenT<ISceneObject>, IActionT<number>, IObject {
    getGame(): IGame;
