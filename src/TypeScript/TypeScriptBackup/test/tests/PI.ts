...
import { IMeasurement } from "../../src/Library/Measurements/Interfaces/IMeasurement";
import { RandomGenerator } from "../../src/Library/Measurements/RandomGenerator";
import { RecursiveFormula } from "../../src/Library/Measurements/RecursiveFormula";
import { VectorFormulaConsumer } from "../../src/Library/Measurements/VectorFormulaConsumer";

class PI_CategoryObject_0 extends RandomGenerator
{
...
class PI_CategoryObject_1 extends RandomGenerator
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
class PI_CategoryObject_2 extends VectorFormulaConsumer
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
class PI_CategoryObject_3 extends RecursiveFormula
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
class PI_CategoryObject_4 extends DataConsumer
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
class PI_CategoryArrow_0 extends DataLink
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
class PI_CategoryArrow_1 extends DataLink
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
class PI_CategoryArrow_2 extends DataLink
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
class PI_CategoryArrow_3 extends DataLink
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
export class PI extends Desktop
{
	constructor()
	{
		super();
