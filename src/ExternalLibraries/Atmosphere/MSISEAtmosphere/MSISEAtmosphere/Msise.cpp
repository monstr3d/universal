...
void Msise::gtd7(struct nrlmsise_input *input, struct nrlmsise_flags *flags, struct nrlmsise_output *output) {
	double xlat;
	double xmm;
	int mn3 = 5;
...
void Msise::gtd7d(struct nrlmsise_input *input, struct nrlmsise_flags *flags, struct nrlmsise_output *output) {
...
void Msise::gtd7(struct nrlmsise_input *input, struct nrlmsise_output *output) 
{
	gtd7(input, &flags, output);
}
...
void Msise::gtd7d(struct nrlmsise_input *input, struct nrlmsise_output *output) 
{
...
void Msise::tselec(bool * b)
{
	for (int i = 0; i < 24; i++)
	{
		flags.switches[i] = b ? 1 : 0;
	}
	tselec(&flags);
}

void Msise::tselec(struct nrlmsise_flags *flags) {
	int i;
	for (i=0;i<24;i++) {
		if (i!=9) {
...
void Msise::glatf(double lat, double *gv, double *reff) {
...
double Msise::ccor(double alt, double r, double h1, double zh) {
...
double Msise::ccor2(double alt, double r, double h1, double zh, double h2) {
/*        CHEMISTRY/DISSOCIATION CORRECTION FOR MSIS MODELS
 *         ALT - altitude
 *         R - target ratio
 *         H1 - transition scale length
...
double Msise::scalh(double alt, double xm, double temp) {
	double g;
	double rgas=831.4;
...
double Msise::dnet (double dd, double dm, double zhm, double xmm, double xm) {
...
void Msise::splini (double *xa, double *ya, double *y2a, int n, double x, double *y) {
...
void Msise::splint (double *xa, double *ya, double *y2a, int n, double x, double *y) {
...
void Msise::spline (double *x, double *y, int n, double yp1, double ypn, double *y2) {
...
double Msise::zeta(double zz, double zl) {
	return ((zz-zl)*(re+zl)/(re+zz));
}

double Msise::densm(double alt, double d0, double xm, double *tz, int mn3, double *zn3, 
...
double Msise::densu (double alt, double dlb, double tinf, double tlb, 
...
double Msise::globe7(double *p, struct nrlmsise_input *input, struct nrlmsise_flags *flags) {
...
double Msise::glob7s(double *p, struct nrlmsise_input *input, struct nrlmsise_flags *flags) {
...
void Msise::ghp7(struct nrlmsise_input *input, struct nrlmsise_flags *flags, 
...
void Msise::gts7(struct nrlmsise_input *input, struct nrlmsise_flags *flags, struct nrlmsise_output *output) {
