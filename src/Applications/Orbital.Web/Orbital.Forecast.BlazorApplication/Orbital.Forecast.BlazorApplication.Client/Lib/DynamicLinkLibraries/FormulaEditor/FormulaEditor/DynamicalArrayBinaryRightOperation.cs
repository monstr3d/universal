...
{
    class DynamicalArrayBinaryRightOperation : IObjectOperation, IInternalOperation
    {
        ...
        internal DynamicalArrayBinaryRightOperation(object typeA, object typeB, IObjectOperation op)
        {
