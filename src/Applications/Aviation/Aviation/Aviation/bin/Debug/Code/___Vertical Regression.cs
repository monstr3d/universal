...
namespace Calculation
{
	...
	public class Calculate : FormulaEditor.Interfaces.ITreeCollectionProxy
	{
		...
		double var_0 = 0;
		double[] var_1 = new double[142];
		double[] var_2 = new double[142];
		double var_3 = 0;
		object[] var_4 = new object[142];
		double[] var_5 = new double[67];
		double[] var_6 = new double[67];
		double var_7 = 0;
		object[] var_8 = new object[67];
