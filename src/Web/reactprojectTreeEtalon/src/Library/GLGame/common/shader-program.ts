...
export default class ShaderProgram {
    ...
    public setUniform1fv(name: string, data: Float32Array, srcOffset?: number, srcLength?: number) {
    ...
    public setUniform1iv(name: string, data: Int32Array, srcOffset?: number, srcLength?: number) {
    ...
    public setUniform1uiv(name: string, data: Uint32Array, srcOffset?: number, srcLength?: number) {
    ...
    public setUniform2fv(name: string, data: Float32Array, srcOffset?: number, srcLength?: number) {
    ...
    public setUniform2iv(name: string, data: Int32Array, srcOffset?: number, srcLength?: number) {
        this.gl.uniform2iv(this.gl.getUniformLocation(this.program, name), data, srcOffset, srcLength);
    }

    public setUniform2ui(name: string, v: Uint32Array) {
        this.gl.uniform2ui(this.gl.getUniformLocation(this.program, name), v[0], v[1]);
    }

    public setUniform2uiv(name: string, data: Uint32Array, srcOffset?: number, srcLength?: number) {
    ...
    public setUniform3fv(name: string, data: Float32Array, srcOffset?: number, srcLength?: number) {
    ...
    public setUniform3iv(name: string, data: Int32Array, srcOffset?: number, srcLength?: number) {
    ...
    public setUniform3uiv(name: string, data: Uint32Array, srcOffset?: number, srcLength?: number) {
    ...
    public setUniform4fv(name: string, data: Float32Array, srcOffset?: number, srcLength?: number) {
    ...
    public setUniform4iv(name: string, data: Int32Array, srcOffset?: number, srcLength?: number) {
    ...
    public setUniform4uiv(name: string, data: Uint32Array, srcOffset?: number, srcLength?: number) {
        this.gl.uniform4uiv(this.gl.getUniformLocation(this.program, name), data, srcOffset, srcLength);
    }

    // Matrix Setters

    public setUniformMatrix2fv(name: string, transpose: boolean, data: Float32Array, srcOffset?: number, srcLength?: number){
        this.gl.uniformMatrix2fv(this.gl.getUniformLocation(this.program, name), transpose, data, srcOffset, srcLength);
    }

    public setUniformMatrix2x3fv(name: string, transpose: boolean, data: Float32Array, srcOffset?: number, srcLength?: number){
        this.gl.uniformMatrix2x3fv(this.gl.getUniformLocation(this.program, name), transpose, data, srcOffset, srcLength);
    }

    public setUniformMatrix2x4fv(name: string, transpose: boolean, data: Float32Array, srcOffset?: number, srcLength?: number){
        this.gl.uniformMatrix2x4fv(this.gl.getUniformLocation(this.program, name), transpose, data, srcOffset, srcLength);
    }

    public setUniformMatrix3fv(name: string, transpose: boolean, data: Float32Array, srcOffset?: number, srcLength?: number){
        this.gl.uniformMatrix3fv(this.gl.getUniformLocation(this.program, name), transpose, data, srcOffset, srcLength);
    }

    public setUniformMatrix3x2fv(name: string, transpose: boolean, data: Float32Array, srcOffset?: number, srcLength?: number){
        this.gl.uniformMatrix3x2fv(this.gl.getUniformLocation(this.program, name), transpose, data, srcOffset, srcLength);
    }

    public setUniformMatrix3x4fv(name: string, transpose: boolean, data: Float32Array , srcOffset?: number, srcLength?: number){
        this.gl.uniformMatrix3x4fv(this.gl.getUniformLocation(this.program, name), transpose, data, srcOffset, srcLength);
    }

    public setUniformMatrix4fv(name: string, transpose: boolean, data: Float32Array, srcOffset?: number, srcLength?: number){
        this.gl.uniformMatrix4fv(this.gl.getUniformLocation(this.program, name), transpose, data, srcOffset, srcLength);
    }

    public setUniformMatrix4x2fv(name: string, transpose: boolean, data: Float32Array, srcOffset?: number, srcLength?: number){
        this.gl.uniformMatrix4x2fv(this.gl.getUniformLocation(this.program, name), transpose, data, srcOffset, srcLength);
    }
    
    public setUniformMatrix4x3fv(name: string, transpose: boolean, data: Float32Array, srcOffset?: number, srcLength?: number){
